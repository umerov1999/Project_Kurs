...
class CoinOperationAdapter(
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.operationCoin.text =
            mContext.getString(R.string.rub, String.format(Utils.appLocale, "%.2f", item.coin))
        holder.operationTitle.text = item.title
        ...
        if (lastMessageJavaTime < mStartOfToday) {
            holder.operationDate.setTextColor(CurrentTheme.getSecondaryTextColor(mContext))
    ...
    class Holder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val operationTitle: TextView = itemView.findViewById(R.id.item_operation_title)
