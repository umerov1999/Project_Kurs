...
import dev.umerov.project.util.serializeble.json.internal.JsonEncodingException
import dev.umerov.project.util.serializeble.json.internal.SuppressAnimalSniffer
import dev.umerov.project.util.serializeble.json.internal.lexer.StringJsonLexer
import dev.umerov.project.util.serializeble.json.internal.printQuoted
import dev.umerov.project.util.serializeble.json.internal.toBooleanStrictOrNull
...
internal val jsonUnquotedLiteralDescriptor: SerialDescriptor =
    InlinePrimitiveDescriptor(
        "dev.umerov.project.util.serializeble.json.JsonUnquotedLiteral",
        String.serializer()
    )
