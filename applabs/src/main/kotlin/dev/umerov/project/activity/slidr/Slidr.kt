...
import dev.umerov.project.activity.slidr.model.SlidrInterface
import dev.umerov.project.activity.slidr.widget.SliderPanel
...
object Slidr {
     ...
     * @return a [dev.umerov.project.activity.slidr.model.SlidrInterface] that allows
    ...
    /**
     * Attach a slider mechanism to an activity based on the passed [dev.umerov.project.activity.slidr.model.SlidrConfig]
     *
     * @param activity the activity to attach the slider to
