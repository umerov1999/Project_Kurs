package dev.umerov.project.util.serializeble.msgpack.internal

import dev.umerov.project.util.serializeble.msgpack.MsgPackConfiguration
import dev.umerov.project.util.serializeble.msgpack.exceptions.MsgPackSerializationException
import dev.umerov.project.util.serializeble.msgpack.stream.MsgPackDataOutputArrayBuffer
import dev.umerov.project.util.serializeble.msgpack.stream.MsgPackDataOutputArrayBufferCompressed
import dev.umerov.project.util.serializeble.msgpack.stream.MsgPackDataOutputBuffer
import dev.umerov.project.util.serializeble.msgpack.types.MsgPackType
import dev.umerov.project.util.serializeble.msgpack.utils.splitToByteArray
...
internal class BasicMsgPackEncoder(
    ...
    override fun beginStructure(descriptor: SerialDescriptor): CompositeEncoder {
        return if (descriptor.kind in arrayOf(StructureKind.CLASS, StructureKind.OBJECT)) {
            if (descriptor.serialName == "dev.umerov.project.util.serializeble.msgpack.extensions.MsgPackExtension") {
