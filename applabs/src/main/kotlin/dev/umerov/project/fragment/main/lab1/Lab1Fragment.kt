...
class Lab1Fragment : BaseMvpFragment<Lab1Presenter, ILab1View>(),
    ILab1View {
    override fun onResume() {
        ...
        if (actionBar != null) {
            actionBar.setTitle(R.string.lab_1)
    ...
    override fun getPresenterFactory(saveInstanceState: Bundle?) = Lab1Presenter()
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_lab1, container, false)
        (requireActivity() as AppCompatActivity).setSupportActionBar(root.findViewById(R.id.toolbar))
        return root
    }

    companion object {
        fun newInstance(): Lab1Fragment {
            return Lab1Fragment()
        }
    }
