...
Java_dev_umerov_project_module_StringExist_init(JNIEnv *, jobject, jboolean useMutex) {
    return (jlong) (intptr_t) new StringExist(useMutex);
}

extern "C" JNIEXPORT void
Java_dev_umerov_project_module_StringExist_destroy(JNIEnv *, jobject, jlong pointer) {
    if (!pointer) {
        return;
    }
...
extern "C" JNIEXPORT void
Java_dev_umerov_project_module_StringExist_clear(JNIEnv *, jobject, jlong pointer) {
    if (!pointer) {
        return;
    }
...
extern "C" JNIEXPORT jlong
Java_dev_umerov_project_module_BufferWriteNative_allocateBuffer(JNIEnv *, jobject, jint size) {
...
extern "C" JNIEXPORT void
Java_dev_umerov_project_module_BufferWriteNative_endString(JNIEnv *, jobject, jlong pointer) {
    if (!pointer) {
        return;
    }
...
Java_dev_umerov_project_module_BufferWriteNative_bufferSize(JNIEnv *, jobject, jlong pointer) {
    if (!pointer) {
        return 0;
    }
...
extern "C" JNIEXPORT void
Java_dev_umerov_project_module_BufferWriteNative_releaseBuffer(JNIEnv *, jobject, jlong pointer) {
    if (!pointer) {
        return;
    }
...
Java_dev_umerov_project_module_StringHash_getSha1(JNIEnv *env, jobject, jstring value) {
    char const *textString = SafeGetStringUTFChars(env, value, nullptr);
    if (!textString) {
