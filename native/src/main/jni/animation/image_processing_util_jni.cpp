...
Java_dev_umerov_project_module_ImageProcessingUtilNative_nativeCopyBetweenByteBufferAndBitmap(
        JNIEnv *env,
        jobject,
        jobject bitmap,
...
extern "C" JNIEXPORT jint
Java_dev_umerov_project_module_ImageProcessingUtilNative_nativeShiftPixel(
        JNIEnv *env,
        jobject,
        jobject src_y,
        jint src_stride_y,
 ...
 */
extern "C" JNIEXPORT jint
Java_dev_umerov_project_module_ImageProcessingUtilNative_nativeWriteJpegToSurface(
        JNIEnv *env,
        jobject,
...
extern "C" JNIEXPORT jint
Java_dev_umerov_project_module_ImageProcessingUtilNative_nativeConvertAndroid420ToABGR(
        JNIEnv *env,
        jobject,
        jobject src_y,
        jint src_stride_y,
...
extern "C" JNIEXPORT jint
Java_dev_umerov_project_module_ImageProcessingUtilNative_nativeConvertAndroid420ToBitmap(
        JNIEnv *env,
        jobject,
        jobject src_y,
        jint src_stride_y,
...
extern "C" JNIEXPORT jint Java_dev_umerov_project_module_ImageProcessingUtilNative_nativeRotateYUV(
        JNIEnv *env,
        jobject,
        jobject src_y,
        jint src_stride_y,
