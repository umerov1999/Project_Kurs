...
Java_dev_umerov_project_module_rlottie_RLottieDrawable_create(JNIEnv *env, jobject, jstring src,
                                                               jintArray data,
...
extern "C" JNIEXPORT jlong
Java_dev_umerov_project_module_rlottie_RLottieDrawable_createWithJson(JNIEnv *env, jobject,
                                                                       jlong json,
                                                                       jintArray data,
                                                                       jintArray colorReplacement,
                                                                       jboolean useMoveColor) {
...
Java_dev_umerov_project_module_rlottie_RLottieDrawable_destroy(JNIEnv *, jobject, jlong ptr) {
    if (!ptr) {
        return;
    }
...
extern "C" JNIEXPORT void
Java_dev_umerov_project_module_rlottie_RLottieDrawable_setLayerColor(JNIEnv *env, jobject,
                                                                      jlong ptr,
...
extern "C" JNIEXPORT void
Java_dev_umerov_project_module_rlottie_RLottieDrawable_replaceColors(JNIEnv *env, jobject,
                                                                      jlong ptr,
                                                                      jintArray colorReplacement) {
...
Java_dev_umerov_project_module_rlottie_RLottieDrawable_getFrame(JNIEnv *env, jobject, jlong ptr,
                                                                 jint frame,
...
extern "C" JNIEXPORT
jboolean
Java_dev_umerov_project_module_rlottie_RLottie2Gif_lottie2gif(JNIEnv *env, jobject, jlong json,
                                                               jobject bitmap, jint w, jint h,
