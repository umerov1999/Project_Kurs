...
Java_dev_umerov_project_module_thorvg_ThorVGRender_registerColorsNative(JNIEnv *env, jobject,
                                                                         jstring name,
                                                                         jint value) {
...
extern "C" JNIEXPORT void
Java_dev_umerov_project_module_thorvg_ThorVGRender_createBitmapNative(JNIEnv *env, jobject,
